 ...
 *  amb JavaFX. Incorpora un menu amb una ajuda amb el
 *  component Webview
 * @author sergi grau
 * @version 1.0 19.01.2015
 */
public class ConversorMenuAjuda extends Application {
    ...
    public void start(Stage stage) throws Exception {
        Parent arrel = FXMLLoader.load(getClass().getResource("ConversorMenuAjuda.fxml"));
